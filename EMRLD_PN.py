...
def maml_a2c_loss(train_episodes, learner, baseline, gamma, tau, task_data, w_a2c, w_bc):
	...
	if train_episodes is None:
		...
		# print(f"In maml_a2c_loss, bc_loss_2:{bc_loss_2}, a2c_loss:{a2c_loss}") # shape=1, scalar value
...
def main(
	...
	print("If this line is shown before BrokenPipeError and you fail to find another print, then env.close() fail")	
	env.close()
	print("If this line is shown before BrokenPipeError, then env.close() successfully")
	return 1
